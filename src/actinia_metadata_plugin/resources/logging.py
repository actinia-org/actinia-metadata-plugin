...
# -*- coding: utf-8 -*-
"""
SPDX-FileCopyrightText: (c) 2019-2021 mundialis GmbH & Co. KG
...
from actinia_metadata_plugin.resources.config import LOGCONFIG


log = logging.getLogger('actinia-metadata-plugin')
